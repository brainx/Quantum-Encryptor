...
class TestPEMKeyFormat:
    ...
    def test_save_load_public_key_pem(self, key_pair):
    ...
    def test_save_load_private_key_pem_no_password(self, key_pair):
    ...
    def test_save_load_private_key_pem_with_password(self, key_pair):
        ...
        loaded_key_wrong, loaded_alg_wrong, loaded_type_wrong = core.load_key_pem(
...
class TestFileEncryption:
    ...
    def test_encrypt_decrypt_file(self, key_pair):
    ...
    def test_decrypt_with_wrong_key(self, key_pair):
        ...
        decrypted_data, detected_alg = core.decrypt_file_pro(encrypted_data, wrong_private_key)
